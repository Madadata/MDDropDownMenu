  ...
  _createClass(MDDropDownMenu, [{
    ...
    value: function componentDidMount() {
      ...
      (0, _jquery2.default)(document).bind('click', function (e) {
        var parents = (0, _jquery2.default)(e.target).parents();
        var target = (0, _jquery2.default)('#' + mdDropDownMenu.state.id)[0];
        var parentsHasId = false;
        ...
        if (!parentsHasId) {
          (0, _jquery2.default)('#' + mdDropDownMenu.state.id + ' ul').hide();
        }
      });
    }
  }, {
